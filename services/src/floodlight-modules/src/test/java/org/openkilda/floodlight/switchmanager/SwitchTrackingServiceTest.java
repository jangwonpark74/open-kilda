...
public class SwitchTrackingServiceTest extends EasyMockSupport {
    ...
    public void switchAdded() throws Exception {
        ...
        verifySwitchEvent(SwitchState.ADDED, expectedSwitchRecord, producedMessage);
    }
    ...
    public void switchAddedMissing() throws Exception {
        ...
        replayAll();
        service.switchAdded(dpId);
        verifySwitchEvent(SwitchState.ADDED, null, producedMessage);
    }
    ...
    public void switchRemoved() {
        ...
        verifySwitchEvent(SwitchState.REMOVED, null, producedMessage);
    }
    ...
    private void switchActivateTest(Capture<Message> producedMessage, Switch expectedSwitchRecord) throws Exception {
        ...
        verifySwitchEvent(SwitchState.ACTIVATED, expectedSwitchRecord, producedMessage);
    ...
    public void switchDeactivated() throws Exception {
        ...
        verifySwitchEvent(SwitchState.DEACTIVATED, null, producedMessage);
    }
    ...
    public void switchChanged() throws Exception {
        ...
        verifySwitchEvent(SwitchState.CHANGED, expectedSwitchRecord, producedMessage);
    }
    ...
    public void switchChangedMissing() throws Exception {
        ...
        replayAll();
        service.switchChanged(dpId);
        verifySwitchEvent(SwitchState.CHANGED, null, producedMessage);
    }
    ...
    private void verifySwitchEvent(SwitchState expectedState, Switch expectedSwitchRecord,

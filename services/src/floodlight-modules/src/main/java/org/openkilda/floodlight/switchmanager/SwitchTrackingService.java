...
public class SwitchTrackingService implements IOFSwitchListener, IService {
    ...
    private void switchDiscoveryAction(DatapathId dpId, SwitchState event) {
        ...
        producerService.sendMessageAndTrack(discoveryTopic, message);
    }
     ...
     * @return Message
     */
    private static Message buildSwitchMessage(IOFSwitch sw, Switch switchRecord, SwitchState eventType) {

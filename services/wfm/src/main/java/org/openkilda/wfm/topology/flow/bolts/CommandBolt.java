    ...
    private void processCreateFlow(String correlationId, Tuple tuple, Flow flow) {
        ...
        for (int i = rules.size() - 1; i > 0; i--) {
            try {
                ...
                Values values = new Values(MAPPER.writeValueAsString(message), rule.getSwitchId(), flow.getFlowId(), rule.getTransactionId());
